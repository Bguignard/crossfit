...
Programming generation payloads may also include
`source_analysis_request_id` when the request reuses or waits for a personal
performance analysis generated by Symfony.
