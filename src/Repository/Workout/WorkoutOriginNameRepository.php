 ...
 */
class WorkoutOriginNameRepository extends ServiceEntityRepository implements WorkoutOriginNameRepositoryInterface
{
    ...
    public function persist(WorkoutOriginName $workoutOriginName): WorkoutOriginName
    {
