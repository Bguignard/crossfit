...
#[ApiResource]
class WorkoutType implements ConvertibleToDTOInterface
{
    #[ORM\Id]
    ...
    public function getNameAsEnum(): WorkoutTypeEnum
    {
        return WorkoutTypeEnum::from($this->name);
    }
}
