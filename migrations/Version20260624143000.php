...
final class Version20260624143000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_PROGRAMMING_GENERATION_COACHED_CLIENT ON programming_generation_request (coached_client_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_PROGRAMMING_GENERATION_COACHED_CLIENT');
